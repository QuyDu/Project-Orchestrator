...
Generated by a complete repository scan at 2026-09-18T14:26:22.324Z.
...
- **reports** — Top-level project boundary containing 95 scanned files.
  Evidence: `reports/adoption-rerun-evidence.json`
- **schemas** — Top-level project boundary containing 54 scanned files.
...
- **.md** — 138 scanned files use this extension.
  Evidence: `.github/agents/visual-storytelling-director.agent.md`
- **.json** — 125 scanned files use this extension.
  Evidence: `.azure/environment.json`
...
- Repository digest: `132196b1c139d9522e1fe1e6e4508bcad16ea9443da19ebd52b5f2ab49468e5f`
- Files scanned: 367
- Source files: 21
- Tests: 16
- Skills: 47
