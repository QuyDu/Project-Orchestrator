...
- **.github**: Top-level project boundary containing 88 scanned files.
...
- **reports**: Top-level project boundary containing 97 scanned files.
- **schemas**: Top-level project boundary containing 58 scanned files.
...
- **tests**: Top-level project boundary containing 23 scanned files.

## Technology

- **.md**: 141 scanned files use this extension.
- **.json**: 130 scanned files use this extension.
- **.mjs**: 47 scanned files use this extension.
...
- **Governed skill workflows**: 48 installed skills provide bounded project actions.
